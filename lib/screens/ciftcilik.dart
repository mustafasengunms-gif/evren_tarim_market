...
// BU DA ONAYLI SİLME FONKSİYONU (KAZAYI ÖNLER)
  ...
  Future<void> _kayitSil(String id, String kaynak, dynamic firmaId, double tutar) async {
    try {
      ...
      // 2. SQL'den sil VE Borcu Düzelt
      // Parametre isimlerini (id:, firmaId:, tutar:) eklemeyi unutmayın!
      await DatabaseHelper.instance.tarlaHareketiSil(
          id: id,
          firmaId: firmaId,
          tutar: tutar
      );
      ...
      _verileriYukle();
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Kayıt ve ilgili bakiye silindi.")));
    } catch (e) {
  ...
  String formatTL(dynamic deger) {
    ...
    return format.format(double.tryParse(deger.toString()) ?? 0);
  }
